import { _ as _sfc_main$9 } from './Checkbox-rlh6ivBn.mjs';
import { q as useI18n, u as useHead, x as usePhotos, D as useToast, aM as formatBytes, j as __nuxt_component_2$1, R as _sfc_main$8$1, aY as __nuxt_component_1, l as __nuxt_component_0$4, n as useDayjs, a as __nuxt_component_0$5, B as _sfc_main$v, Q as _sfc_main$B, at as _sfc_main$z, _ as _export_sfc, T as useAppConfig, aF as useLocale, am as createReusableTemplate, a8 as useFormField, W as tv, X as _sfc_main$y, S as Primitive, af as VisuallyHidden_default, ag as useForwardPropsEmits, V as reactivePick, aZ as omit, a9 as useFieldGroup, aa as useComponentIcons, m as motion, aN as _sfc_main$u, k as _sfc_main$n, ak as usePortal, aI as reactiveOmit, ar as isArrayOfArray, as as get, a_ as _sfc_main$w, a$ as pickLinkProps, b0 as _sfc_main$x, h as useVModel$1, Y as useForwardExpose, aX as useFocusWithin, ao as useCollection, ae as createContext$1, z as __nuxt_component_0, aL as setInterval } from './server.mjs';
import { _ as _sfc_main$1$1, a as _sfc_main$i } from './DashboardNavbar-DOwENe-X.mjs';
import { _ as _sfc_main$k } from './Alert-CTrMCRBw.mjs';
import { defineComponent, computed, ref, reactive, watch, useTemplateRef, h, resolveComponent, withCtx, unref, createTextVNode, toDisplayString, createVNode, isRef, createBlock, openBlock, createCommentVNode, withModifiers, mergeModels, useSlots, useModel, toRef, mergeProps, Fragment, renderSlot, renderList, resolveDynamicComponent, withKeys, createSlots, toRefs, toRaw, nextTick, readonly, useSSRContext } from 'vue';
import { ssrRenderComponent, ssrInterpolate, ssrRenderStyle, ssrRenderSlot, ssrRenderClass, ssrRenderList, ssrRenderVNode, ssrRenderAttrs } from 'vue/server-renderer';
import { _ as _sfc_main$1$2, a as _sfc_main$e } from './Modal-BpC2u0WJ.mjs';
import { _ as _sfc_main$a, D as DropdownMenuRoot_default, a as DropdownMenuTrigger_default, b as DropdownMenuArrow_default, c as DropdownMenu, u as useArrowNavigation } from './Popover-CExH6mye.mjs';
import { _ as _sfc_main$b, a as _sfc_main$1$5 } from './Tooltip-DdVqfxhL.mjs';
import { _ as _sfc_main$1$3, a as _sfc_main$c } from './SelectMenu-B-dQe02o.mjs';
import { _ as _sfc_main$g } from './Input-BDsxCbzM.mjs';
import { _ as _sfc_main$j } from './Tabs-BgfmQzYA.mjs';
import { u as usePhotoFilters, a as usePhotoSort } from './usePhotoFilters-aLj9DRyf.mjs';
import { ar as defu, az as isEqual } from '../nitro/nitro.mjs';
import { _ as _sfc_main$d } from './Table-BqdcNZXo.mjs';
import { _ as _sfc_main$1$4, a as _sfc_main$f } from './FormField-DW0IB9L7.mjs';
import { _ as _sfc_main$h } from './Textarea-BK55nnMy.mjs';
...
import { _ as __nuxt_component_1$1 } from './ProviderMarker-mg7v0cM5.mjs';
import { _ as __nuxt_component_28 } from './Photo-D3FCyxMB.mjs';
...
const [injectTagsInputRootContext, provideTagsInputRootContext] = createContext$1("TagsInputRoot");
...
const [injectTagsInputItemContext, provideTagsInputItemContext] = createContext$1("TagsInputItem");
...
const _sfc_main$8 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props, { emit: __emit }) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      const _component_UBadge = _sfc_main$8$1;
      const _component_UButton = _sfc_main$v;
      const _component_UProgress = _sfc_main$u;
      ...
      _push(ssrRenderComponent(unref(motion).div, mergeProps({
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<div class="flex items-start justify-between" data-v-96de8c31${_scopeId}><div class="flex items-center gap-3 flex-1 min-w-0" data-v-96de8c31${_scopeId}>`);
            _push2(ssrRenderComponent(unref(motion).div, {
              ...
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  ...
                  }, "w-10 h-10 rounded-lg border flex items-center justify-center"])}" data-v-96de8c31${_scopeId2}>`);
                            ...
                            default: withCtx((_4, _push5, _parent5, _scopeId4) => {
                              if (_push5) {
                                ...
                                ssrRenderList(particleCount, (i) => {
                                  _push5(`<div class="absolute top-1/2 left-1/2 w-1.5 h-1.5 rounded-full particle-burst" style="${ssrRenderStyle(generateParticleStyle(i - 1))}" data-v-96de8c31${_scopeId4}></div>`);
                                });
                                _push5(`<!--]-->`);
                              } else {
                                return [
            ...
            _push2(`<div class="flex-1 min-w-0" data-v-96de8c31${_scopeId}><div class="flex items-center gap-2 mb-1" data-v-96de8c31${_scopeId}><p class="font-medium text-sm truncate text-neutral-900 dark:text-neutral-100" data-v-96de8c31${_scopeId}>${ssrInterpolate(__props.uploadingFile.fileName)}</p>`);
            ...
            _push2(`</div><div class="flex items-center gap-1 text-xs text-neutral-500 dark:text-neutral-400" data-v-96de8c31${_scopeId}><span data-v-96de8c31${_scopeId}>${ssrInterpolate(formatBytes2(__props.uploadingFile.file.size))}</span>`);
            if (__props.uploadingFile.uploadProgress?.speedText && __props.uploadingFile.status === "uploading") {
              _push2(`<span class="hidden sm:inline" data-v-96de8c31${_scopeId}> • ${ssrInterpolate(__props.uploadingFile.uploadProgress.speedText)}</span>`);
            } else {
              _push2(`<!---->`);
            }
            _push2(`</div></div></div><div class="flex items-center gap-2 ml-2" data-v-96de8c31${_scopeId}>`);
                      ...
                      default: withCtx((_3, _push4, _parent4, _scopeId3) => {
                        if (_push4) {
                          if (__props.uploadingFile.status === "uploading") {
                            _push4(`<div class="space-y-1" data-v-96de8c31${_scopeId3}><div class="flex justify-between items-center" data-v-96de8c31${_scopeId3}><span class="text-xs text-neutral-600 dark:text-neutral-400" data-v-96de8c31${_scopeId3}> 上传进度 </span><span class="text-xs font-mono text-neutral-600 dark:text-neutral-400" data-v-96de8c31${_scopeId3}>${ssrInterpolate(__props.uploadingFile.progress)}% </span></div>`);
                            _push4(ssrRenderComponent(unref(motion).div, {
                              class: "relative",
                              initial: { scaleX: 0 },
                              animate: { scaleX: 1 },
                            ...
                            if (__props.uploadingFile.uploadProgress?.timeRemainingText) {
                              _push4(`<div class="text-xs text-neutral-500 dark:text-neutral-400" data-v-96de8c31${_scopeId3}> 剩余时间: ${ssrInterpolate(__props.uploadingFile.uploadProgress.timeRemainingText)}</div>`);
                            } else {
                              _push4(`<!---->`);
                            }
                            _push4(`</div>`);
                          ...
                          if (__props.uploadingFile.status === "processing") {
                            _push4(`<div class="space-y-1" data-v-96de8c31${_scopeId3}><div class="flex justify-between items-center" data-v-96de8c31${_scopeId3}><span class="text-xs text-neutral-600 dark:text-neutral-400" data-v-96de8c31${_scopeId3}> 处理状态 </span>`);
...
const __nuxt_component_2 = /* @__PURE__ */ Object.assign(_export_sfc(_sfc_main$8, [["__scopeId", "data-v-96de8c31"]]), { __name: "UploadQueueItem" });
  ...
  setup(__props, { emit: __emit }) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      if (__props.uploadingFiles.size > 0) {
        _push(`<div${ssrRenderAttrs(mergeProps({ class: "fixed bottom-2 inset-x-2 sm:inset-x-6 sm:bottom-6 sm:left-auto z-50 min-w-sm sm:w-md" }, _attrs))} data-v-4c0b2edc>`);
          ...
          default: withCtx((_, _push2, _parent2, _scopeId) => {
            if (_push2) {
              _push2(ssrRenderComponent(unref(motion).div, {
                ...
                default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                  if (_push3) {
                    _push3(`<div class="flex items-center justify-between" data-v-4c0b2edc${_scopeId2}><div class="flex items-center gap-3" data-v-4c0b2edc${_scopeId2}>`);
                    _push3(ssrRenderComponent(_component_Icon, {
                      name: {
                    ...
                    _push3(`<div data-v-4c0b2edc${_scopeId2}><h3 class="font-semibold text-sm text-neutral-900 dark:text-neutral-100" data-v-4c0b2edc${_scopeId2}> 文件上传队列 <span class="text-neutral-500 dark:text-neutral-400" data-v-4c0b2edc${_scopeId2}> (${ssrInterpolate(unref(stats).total)}) </span></h3><div class="flex items-center gap-2 text-xs text-neutral-500 dark:text-neutral-400 mt-1" data-v-4c0b2edc${_scopeId2}>`);
                    if (unref(stats).waiting > 0) {
                      _push3(`<span class="text-neutral-600 dark:text-neutral-400" data-v-4c0b2edc${_scopeId2}>${ssrInterpolate(unref(stats).waiting)} 等待 </span>`);
                    } else {
                      _push3(`<!---->`);
                    }
                    if (unref(stats).active > 0) {
                      _push3(`<span class="text-blue-600 dark:text-blue-400" data-v-4c0b2edc${_scopeId2}>${ssrInterpolate(unref(stats).active)} 进行中 </span>`);
                    } else {
                      _push3(`<!---->`);
                    }
                    if (unref(stats).completed > 0) {
                      _push3(`<span class="text-green-600 dark:text-green-400" data-v-4c0b2edc${_scopeId2}>${ssrInterpolate(unref(stats).completed)} 完成 </span>`);
                    } else {
                      _push3(`<!---->`);
                    }
                    if (unref(stats).error > 0) {
                      _push3(`<span class="text-red-600 dark:text-red-400" data-v-4c0b2edc${_scopeId2}>${ssrInterpolate(unref(stats).error)} 失败 </span>`);
                    } else {
                      _push3(`<!---->`);
                    }
                    if (unref(stats).skipped > 0) {
                      _push3(`<span class="text-yellow-600 dark:text-yellow-400" data-v-4c0b2edc${_scopeId2}>${ssrInterpolate(unref(stats).skipped)} 跳过 </span>`);
                    } else {
                      _push3(`<!---->`);
                    }
                    if (unref(stats).blocked > 0) {
                      _push3(`<span class="text-red-600 dark:text-red-400" data-v-4c0b2edc${_scopeId2}>${ssrInterpolate(unref(stats).blocked)} 被阻止 </span>`);
                    } else {
                      _push3(`<!---->`);
                    }
                    _push3(`</div></div></div><div class="flex items-center gap-2" data-v-4c0b2edc${_scopeId2}>`);
                    if (unref(stats).active > 0) {
                      _push3(`<div class="text-xs text-neutral-500 dark:text-neutral-400 font-mono" data-v-4c0b2edc${_scopeId2}>${ssrInterpolate(unref(overallProgress))}% </div>`);
                    } else {
                      _push3(`<!---->`);
                    }
                    _push3(ssrRenderComponent(unref(motion).div, {
                  ...
                  if (_push3) {
                    if (!unref(isCollapsed)) {
                      _push3(ssrRenderComponent(unref(motion).div, {
                        ...
                        default: withCtx((_3, _push4, _parent4, _scopeId3) => {
                          if (_push4) {
                            _push4(`<div class="p-2 space-y-2" data-v-4c0b2edc${_scopeId3}>`);
                            _push4(ssrRenderComponent(unref(_sfc_main$n), { mode: "popLayout" }, {
                              default: withCtx((_4, _push5, _parent5, _scopeId4) => {
                                if (_push5) {
                                  _push5(`<!--[-->`);
                            ...
                            return [
                              createVNode("div", { class: "p-2 space-y-2" }, [
                                createVNode(unref(_sfc_main$n), { mode: "popLayout" }, {
                                  default: withCtx(() => [
                                    (openBlock(true), createBlock(Fragment, null, renderList(__props.uploadingFiles, ([fileId, uploadingFile]) => {
                                      return openBlock(), createBlock(_component_UploadQueueItem, {
                                        key: fileId,
                  ...
                  if (_push3) {
                    if (!unref(isCollapsed) && (unref(stats).completed > 0 || unref(stats).error > 0)) {
                      _push3(ssrRenderComponent(unref(motion).div, {
                        ...
                        default: withCtx((_3, _push4, _parent4, _scopeId3) => {
                          if (_push4) {
                            _push4(`<div class="flex items-center justify-between gap-2" data-v-4c0b2edc${_scopeId3}><div class="text-xs text-neutral-500 dark:text-neutral-400" data-v-4c0b2edc${_scopeId3}>${ssrInterpolate(unref(stats).completed)} 完成, ${ssrInterpolate(unref(stats).error)} 失败 </div><div class="flex items-center gap-0.5" data-v-4c0b2edc${_scopeId3}>`);
                            if (unref(stats).completed > 0) {
...
const __nuxt_component_7 = /* @__PURE__ */ Object.assign(_export_sfc(_sfc_main$7, [["__scopeId", "data-v-4c0b2edc"]]), { __name: "UploadQueuePanel" });
                  ...
                  ssrRenderSlot(_ctx.$slots, "file", {
                    ...
                    ssrRenderSlot(_ctx.$slots, "file-trailing", {
                      ...
                      if (__props.fileDelete) {
                        _push2(ssrRenderComponent(_sfc_main$v, mergeProps({ color: "neutral" }, { ref_for: true }, {
                          ...layout.value === "grid" ? {
                            variant: "solid",
                            size: "xs"
                          } : {
                      ...
                      return openBlock(), createBlock("div", {
                        ...
                        renderSlot(_ctx.$slots, "file", {
                          ...
                          renderSlot(_ctx.$slots, "file-trailing", {
                            ...
                            __props.fileDelete ? (openBlock(), createBlock(_sfc_main$v, mergeProps({
                              key: 0,
                              color: "neutral"
                            }, { ref_for: true }, {
                              ...layout.value === "grid" ? {
                    ...
                    return [
                      ...
                      (position.value === "inside" ? __props.multiple ? !modelValue.value?.length : !modelValue.value : true) ? (openBlock(), createBlock("div", {
                        ...
                        renderSlot(_ctx.$slots, "leading", { ui: ui.value }, () => [
                          variant.value === "button" ? (openBlock(), createBlock(_sfc_main$B, {
                            key: 0,
                            name: __props.icon || unref(appConfig).ui.icons.upload,
                            "data-slot": "icon",
                            class: ui.value.icon({ class: props.ui?.icon })
                          }, null, 8, ["name", "class"])) : (openBlock(), createBlock(_sfc_main$y, {
                            key: 1,
                            icon: __props.icon || unref(appConfig).ui.icons.upload,
                            size: props.size,
                            "data-slot": "avatar",
...
const _sfc_main$5 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      const _component_UTabs = _sfc_main$j;
      const _component_UBadge = _sfc_main$8$1;
      const _component_Icon = __nuxt_component_0$4;
              ...
              ssrRenderSlot(_ctx.$slots, item.slot ? `${item.slot}-trailing` : "item-trailing", {
                ...
                if (item.children?.length) {
                  ...
                  ssrRenderList(item.kbds, (kbd, kbdIndex) => {
                    _push2(ssrRenderComponent(_sfc_main$1$5, mergeProps({
                      key: kbdIndex,
            ...
            return [
              renderSlot(_ctx.$slots, item.slot || "item", {
                ...
                renderSlot(_ctx.$slots, item.slot ? `${item.slot}-leading` : "item-leading", {
                  ...
                  item.loading ? (openBlock(), createBlock(_sfc_main$B, {
                    key: 0,
                    name: __props.loadingIcon || unref(appConfig).ui.icons.loading,
                    "data-slot": "itemLeadingIcon",
                    class: __props.ui.itemLeadingIcon({ class: [__props.uiOverride?.itemLeadingIcon, item.ui?.itemLeadingIcon], color: item?.color, loading: true })
                  }, null, 8, ["name", "class"])) : item.icon ? (openBlock(), createBlock(_sfc_main$B, {
                    key: 1,
                    name: item.icon,
                    "data-slot": "itemLeadingIcon",
                    class: __props.ui.itemLeadingIcon({ class: [__props.uiOverride?.itemLeadingIcon, item.ui?.itemLeadingIcon], color: item?.color, active })
                ...
                unref(get)(item, props.labelKey) || !!slots[item.slot ? `${item.slot}-label` : "item-label"] || (unref(get)(item, props.descriptionKey) || !!slots[item.slot ? `${item.slot}-description` : "item-description"]) ? (openBlock(), createBlock("span", {
                  ...
                  createVNode("span", {
                    ...
                    item.target === "_blank" && __props.externalIcon !== false ? (openBlock(), createBlock(_sfc_main$B, {
                      key: 0,
                      name: typeof __props.externalIcon === "string" ? __props.externalIcon : unref(appConfig).ui.icons.external,
                      "data-slot": "itemLabelExternalIcon",
                      class: __props.ui.itemLabelExternalIcon({ class: [__props.uiOverride?.itemLabelExternalIcon, item.ui?.itemLabelExternalIcon], color: item?.color, active })
                ...
                createVNode("span", {
                  ...
                  renderSlot(_ctx.$slots, item.slot ? `${item.slot}-trailing` : "item-trailing", {
                    ...
                    item.children?.length ? (openBlock(), createBlock(_sfc_main$B, {
                      key: 0,
                      name: childrenIcon.value,
                      "data-slot": "itemTrailingIcon",
                      class: __props.ui.itemTrailingIcon({ class: [__props.uiOverride?.itemTrailingIcon, item.ui?.itemTrailingIcon], color: item?.color, active })
                      ...
                      (openBlock(true), createBlock(Fragment, null, renderList(item.kbds, (kbd, kbdIndex) => {
                        return openBlock(), createBlock(_sfc_main$1$5, mergeProps({
                          key: kbdIndex,
                          size: item.ui?.itemTrailingKbdsSize || __props.uiOverride?.itemTrailingKbdsSize || __props.ui.itemTrailingKbdsSize()
                          ...
                          ssrRenderList(group, (item, index) => {
                            ...
                            if (item.type === "label") {
                              ...
                              _push4(ssrRenderComponent(unref(DropdownMenu).Item, {
                                ...
                                default: withCtx((_4, _push5, _parent5, _scopeId4) => {
                                  if (_push5) {
                                    _push5(ssrRenderComponent(_sfc_main$w, mergeProps({ ref_for: true }, unref(pickLinkProps)(item), { custom: "" }), {
                                      default: withCtx(({ active, ...slotProps }, _push6, _parent6, _scopeId5) => {
                                        if (_push6) {
                                          _push6(ssrRenderComponent(_sfc_main$x, mergeProps({ ref_for: true }, slotProps, {
                                            "data-slot": "item",
                                          ...
                                          return [
                                            createVNode(_sfc_main$x, mergeProps({ ref_for: true }, slotProps, {
                                              "data-slot": "item",
                                              class: __props.ui.item({ class: [__props.uiOverride?.item, item.ui?.item, item.class], color: item?.color, active })
                                            }), {
                                              default: withCtx(() => [
                                    ...
                                    return [
                                      createVNode(_sfc_main$w, mergeProps({ ref_for: true }, unref(pickLinkProps)(item), { custom: "" }), {
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    const columns = [
      {
        id: "select",
        header: ({ table: table2 }) => h(_sfc_main$9, {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      const _component_UButton = _sfc_main$v;
      const _component_USlideover = _sfc_main$1$2;
      const _component_UFileUpload = _sfc_main$6;
      const _component_UIcon = _sfc_main$B;
      const _component_UPopover = _sfc_main$a;
      const _component_UTooltip = _sfc_main$b;
      const _component_UChip = _sfc_main$z;
      const _component_UCard = _sfc_main$1$3;
      ...
      _push(ssrRenderComponent(_component_UDashboardPanel, _attrs, {
        ...
        body: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            ...
            _push2(ssrRenderComponent(unref(__nuxt_component_0$4), {
            ...
            _push2(ssrRenderComponent(unref(_sfc_main$8$1), {
              variant: "soft",
              color: "primary",
              size: "sm"
            }, {
            ...
            _push2(ssrRenderComponent(_component_UModal, {
              ...
              content: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  ...
                  _push3(ssrRenderComponent(unref(__nuxt_component_0$4), {
                    name: "tabler:trash",
                  ...
                  return [
                    createVNode("div", { class: "p-6 space-y-4" }, [
                      createVNode("div", { class: "flex items-start gap-3" }, [
                        createVNode(unref(__nuxt_component_0$4), {
                          name: "tabler:trash",
                          class: "mt-1 size-6 shrink-0 text-error-500"
                        }),
                        createVNode("div", { class: "space-y-2" }, [
                ...
                createVNode("div", { class: "flex flex-row sm:items-center justify-between gap-3 sm:gap-0 p-3 sm:p-4 bg-neutral-50 dark:bg-neutral-900/50 border border-neutral-200 dark:border-neutral-700 rounded-lg" }, [
                  createVNode("div", { class: "flex items-center gap-2" }, [
                    ...
                    createVNode("div", { class: "flex items-center gap-1 sm:gap-2" }, [
                      unref(livePhotoStats).staticPhotos > 0 ? (openBlock(), createBlock(unref(_sfc_main$8$1), {
                        key: 0,
                        variant: "soft",
                        color: "neutral",
                        size: "sm"
                      ...
                      unref(livePhotoStats).livePhotos > 0 ? (openBlock(), createBlock(unref(_sfc_main$8$1), {
                        key: 1,
                        variant: "soft",
                        color: "warning",
                        size: "sm"
...
//# sourceMappingURL=photos-BoWWtr_a.mjs.map
