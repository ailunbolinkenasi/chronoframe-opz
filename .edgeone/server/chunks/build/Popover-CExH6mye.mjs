import { useSlots, toRef, computed, defineComponent, unref, mergeProps, withCtx, renderSlot, toHandlers, createBlock, createCommentVNode, openBlock, createVNode, normalizeProps, guardReactiveProps, toRefs, ref, resolveDynamicComponent, isRef, withKeys, nextTick, watchEffect, withModifiers, mergeDefaults, watch, useSSRContext } from 'vue';
import { ssrRenderComponent, ssrRenderSlot } from 'vue/server-renderer';
import { ar as defu } from '../nitro/nitro.mjs';
import { T as useAppConfig, V as reactivePick, ag as useForwardPropsEmits, ak as usePortal, W as tv, Y as useForwardExpose, ae as createContext$1, ah as Presence_default, ai as Teleport_default, S as Primitive, h as useVModel$1, U as useForwardProps, s as syncRef, av as createSharedComposable$1, aW as useEmitAsProps, b1 as reactiveOmit$1, ao as useCollection, aq as getActiveElement } from './server.mjs';
import { b as PopperArrow_default, a as PopperAnchor_default, P as PopperRoot_default, c as PopperContent_default, d as PopperContentPropsDefaultValue } from './PopperArrow-Bian-NL1.mjs';
import { g as getOpenState, S as SUB_CLOSE_KEYS, a as getCheckedState, i as isIndeterminate, b as SELECTION_KEYS, c as SUB_OPEN_KEYS, d as isMouseEvent, e as isPointerInGraceArea, F as FIRST_LAST_KEYS, L as LAST_KEYS, f as focusFirst, I as ITEM_SELECT } from './utils-Cesy8nNq.mjs';
...
import { R as RovingFocusGroup_default } from './RovingFocusGroup-CG7oTT_a.mjs';
import { u as useId } from './useId-CmnGJZbL.mjs';
import { u as useGraceArea } from './Tooltip-DdVqfxhL.mjs';
...
const [injectMenuContext, provideMenuContext] = createContext$1(["MenuRoot", "MenuSub"], "MenuContext");
const [injectMenuRootContext, provideMenuRootContext] = createContext$1("MenuRoot");
...
const [injectMenuContentContext, provideMenuContentContext] = createContext$1("MenuContent");
...
const [injectMenuItemIndicatorContext, provideMenuItemIndicatorContext] = createContext$1(["MenuCheckboxItem", "MenuRadioItem"], "MenuItemIndicatorContext");
...
const [injectMenuRadioGroupContext, provideMenuRadioGroupContext] = createContext$1("MenuRadioGroup");
...
const [injectMenuSubContext, provideMenuSubContext] = createContext$1("MenuSub");
...
const [injectPopoverRootContext, providePopoverRootContext] = createContext$1("PopoverRoot");
...
const [injectDropdownMenuRootContext, provideDropdownMenuRootContext] = createContext$1("DropdownMenuRoot");
...
const [injectHoverCardRootContext, provideHoverCardRootContext] = createContext$1("HoverCardRoot");
...
export { DropdownMenuRoot_default as D, _sfc_main as _, DropdownMenuTrigger_default as a, DropdownMenuArrow_default as b, DropdownMenu as c, useArrowNavigation as u };
//# sourceMappingURL=Popover-CExH6mye.mjs.map
