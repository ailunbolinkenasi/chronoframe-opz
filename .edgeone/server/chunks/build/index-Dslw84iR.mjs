import { _ as _export_sfc, x as usePhotos, O as useAsyncData, P as useMediaQuery, y as __nuxt_component_0$6, B as _sfc_main$v, E as useRuntimeConfig, a as __nuxt_component_0$5, m as motion, j as __nuxt_component_2$1, l as __nuxt_component_0$4 } from './server.mjs';
import { _ as _sfc_main$1 } from './Tooltip-DdVqfxhL.mjs';
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "relative min-h-screen bg-neutral-50 dark:bg-neutral-950" }, _attrs))} data-v-f2661c42><div class="absolute inset-x-0 top-0 h-[40vh] sm:h-[60vh] overflow-hidden -z-10 pointer-events-none" data-v-f2661c42><div class="absolute inset-0 flex h-full gap-2 sm:gap-4 opacity-40 dark:opacity-20" data-v-f2661c42><!--[-->`);
      ssrRenderList(unref(columns), (column, colIndex) => {
        _push(`<div class="flex-1 relative overflow-hidden" data-v-f2661c42><div class="${ssrRenderClass([colIndex % 2 === 0 ? "animate-scroll-down" : "animate-scroll-up", "flex flex-col gap-2 sm:gap-4"])}" style="${ssrRenderStyle({
        ...
        ssrRenderList(3, (groupIndex) => {
          ...
          ssrRenderList(column, (photo, photoIndex) => {
            _push(`<div class="w-full rounded-lg overflow-hidden" data-v-f2661c42>`);
      ...
      _push(`<!--]--></div><div class="absolute inset-0 bg-gradient-to-b from-neutral-50/60 via-neutral-50/90 to-neutral-50 dark:from-neutral-950/60 dark:via-neutral-950/90 dark:to-neutral-950" data-v-f2661c42></div></div><div class="absolute top-0 left-0 p-4 sm:p-6 z-20" data-v-f2661c42>`);
      ...
      _push(`</div><div class="flex flex-col items-center pt-24 sm:pt-40 pb-20 px-4 text-center" data-v-f2661c42><h1 class="font-black text-5xl sm:text-7xl tracking-tight drop-shadow-sm text-neutral-900 dark:text-white mb-4" data-v-f2661c42>${ssrInterpolate(_ctx.$t("title.albums"))}</h1><div class="flex items-center gap-3" data-v-f2661c42><span class="h-px w-8 bg-neutral-300 dark:bg-neutral-700" data-v-f2661c42></span><p class="text-lg text-neutral-500 dark:text-neutral-400 font-[Pacifico]" data-v-f2661c42>${ssrInterpolate(unref(config).public.app.slogan)}</p><span class="h-px w-8 bg-neutral-300 dark:bg-neutral-700" data-v-f2661c42></span></div></div><div class="container mx-auto px-6 lg:px-12 pb-24" data-v-f2661c42><div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-x-8 gap-y-12" data-v-f2661c42><!--[-->`);
      ssrRenderList(unref(albums), (album) => {
        _push(ssrRenderComponent(_component_NuxtLink, {
          ...
          default: withCtx((_, _push2, _parent2, _scopeId) => {
            if (_push2) {
              _push2(`<div class="relative h-56 w-full mb-6 flex justify-center items-center perspective-1000" data-v-f2661c42${_scopeId}><!--[-->`);
                ...
                _push2(ssrRenderComponent(unref(motion).div, {
                  ...
                  default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                    if (_push3) {
                      ...
                      if (index2 > 0) {
                        _push3(`<div class="${ssrRenderClass([unref(hoveredAlbum) === album.id ? "opacity-0" : "opacity-100", "absolute inset-0 bg-black/20 dark:bg-black/50 transition-opacity duration-300"])}" data-v-f2661c42${_scopeId2}></div>`);
                      } else {
                        _push3(`<!---->`);
                      }
                    } else {
              ...
              if (!album.photoIds || album.photoIds.length === 0) {
                _push2(`<div class="absolute inset-0 rounded-2xl border-2 border-dashed border-neutral-300 dark:border-neutral-700 bg-neutral-50 dark:bg-neutral-800/50 flex flex-col items-center justify-center gap-3 group-hover:border-primary-400 transition-colors" data-v-f2661c42${_scopeId}><div class="p-3 rounded-full bg-neutral-100 dark:bg-neutral-800 text-neutral-400 group-hover:text-primary-500 group-hover:bg-primary-50 transition-colors" data-v-f2661c42${_scopeId}>`);
                _push2(ssrRenderComponent(_component_Icon, {
                  name: "tabler:photo-off",
                  class: "size-6"
                }, null, _parent2, _scopeId));
                _push2(`</div><p class="text-sm font-medium text-neutral-400" data-v-f2661c42${_scopeId}>${ssrInterpolate(_ctx.$t("ui.album.noImage"))}</p></div>`);
              } else {
                _push2(`<!---->`);
              }
              _push2(`</div><div class="relative px-1" data-v-f2661c42${_scopeId}><div class="flex items-start justify-between gap-4 mb-1" data-v-f2661c42${_scopeId}><h2 class="text-lg font-bold text-neutral-800 dark:text-neutral-100 line-clamp-1 group-hover:text-primary-600 dark:group-hover:text-primary-400 transition-colors" data-v-f2661c42${_scopeId}>${ssrInterpolate(album.title)}</h2><span class="shrink-0 inline-flex items-center px-2 py-0.5 rounded text-xs font-medium bg-neutral-100 text-neutral-600 dark:bg-neutral-800 dark:text-neutral-400" data-v-f2661c42${_scopeId}>`);
              _push2(ssrRenderComponent(_component_Icon, {
                name: "tabler:calendar",
                class: "size-3 mr-1"
              }, null, _parent2, _scopeId));
              _push2(` ${ssrInterpolate(_ctx.$dayjs(album.createdAt).format("YYYY/MM"))}</span></div><p class="text-sm text-neutral-500 dark:text-neutral-500 line-clamp-2 leading-relaxed" data-v-f2661c42${_scopeId}>${ssrInterpolate(album.description || _ctx.$t("ui.album.noDescription"))}</p><div class="mt-3 flex items-center text-xs font-semibold text-primary-600 dark:text-primary-400 opacity-0 -translate-x-2 group-hover:opacity-100 group-hover:translate-x-0 transition-all duration-300" data-v-f2661c42${_scopeId}>${ssrInterpolate(_ctx.$t("ui.action.view_album") || "View Album")} `);
              _push2(ssrRenderComponent(_component_Icon, {
...
const index = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-f2661c42"]]);

export { index as default };
//# sourceMappingURL=index-Dslw84iR.mjs.map
