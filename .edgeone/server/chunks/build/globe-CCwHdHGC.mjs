import { q as useI18n, u as useHead, v as useRoute, w as useRouter, x as usePhotos, p as __nuxt_component_0$1, m as motion, y as __nuxt_component_0$6, l as __nuxt_component_0$4, z as __nuxt_component_0, A as useThrottleFn, j as __nuxt_component_2$1, k as _sfc_main$n, a as __nuxt_component_0$5, n as useDayjs, h as useVModel$1, b as unrefElement$1, f as useMounted$1, s as syncRef, e as defaultWindow$1, r as refAutoReset, t as tryOnScopeDispose$1, d as createEventHook, o as onKeyStroke, g as computedEager } from './server.mjs';
import { _ as __nuxt_component_1 } from './ProviderMarker-mg7v0cM5.mjs';
import { defineComponent, computed, ref, watch, mergeProps, unref, withCtx, createVNode, createBlock, createCommentVNode, openBlock, Fragment, renderList, nextTick, toDisplayString, toRefs, renderSlot, normalizeProps, guardReactiveProps, getCurrentInstance, watchPostEffect, h, Teleport, watchEffect, withModifiers, inject, provide, Comment, cloneVNode, toRef, camelize, toHandlerKey, reactive, normalizeStyle, mergeDefaults, createElementBlock, toValue, useSSRContext } from 'vue';
                        ...
                        _push4(ssrRenderComponent(unref(motion).div, {
                          ...
                          default: withCtx((_4, _push5, _parent5, _scopeId4) => {
                            if (_push5) {
                              ...
                              _push5(ssrRenderComponent(__nuxt_component_2$1, {
                                                ...
                                                if (_push8) {
                                                  _push8(ssrRenderComponent(_component_NuxtLink, {
                                                    ...
                                                    default: withCtx((_8, _push9, _parent9, _scopeId8) => {
                                                      if (_push9) {
                                                        _push9(ssrRenderComponent(__nuxt_component_2$1, {
                                    ...
                                    _push6(ssrRenderComponent(unref(motion).div, {
                                      ...
                                      default: withCtx((_6, _push7, _parent7, _scopeId6) => {
                                        if (_push7) {
                                          ...
                                          _push7(ssrRenderComponent(__nuxt_component_2$1, {
                                            src: unref(marker).thumbnailUrl,
                                            alt: unref(marker).title || `照片 ${unref(marker).id}`,
                                            thumbhash: unref(marker).thumbnailHash,
                                            threshold: 0.1,
...
//# sourceMappingURL=globe-CCwHdHGC.mjs.map
