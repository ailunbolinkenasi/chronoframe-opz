...
import { defineEventHandler, handleCacheHeaders, splitCookiesString, createEvent, fetchWithEvent, isEvent, eventHandler, setHeaders, sendRedirect, proxyRequest, getRequestHeader, setResponseHeaders, setResponseStatus, send, getRequestHeaders, setResponseHeader, appendResponseHeader, getRequestURL, getResponseHeader, getResponseStatus, createError, getCookie, deleteCookie, setCookie, getQuery as getQuery$1, getRequestProtocol, getRequestHost, useSession, removeResponseHeader, readBody, setHeader, getRouterParam, lazyEventHandler, useBase, createApp, createRouter as createRouter$1, toNodeListener, sendError, getValidatedRouterParams, readValidatedBody, getHeaders, getRequestIP, getMethod, getHeader, readRawBody, createEventStream, getValidatedQuery, sendStream, getResponseStatusText, H3Error } from 'file:///Users/xiaoyou/Desktop/chronoframe/node_modules/.pnpm/h3@1.15.4/node_modules/h3/dist/index.mjs';
import { Server } from 'node:http';
import path, { resolve, dirname, join } from 'node:path';
import crypto$1 from 'node:crypto';
import { parentPort, threadId } from 'node:worker_threads';
import wsAdapter from 'file:///Users/xiaoyou/Desktop/chronoframe/node_modules/.pnpm/crossws@0.3.5/node_modules/crossws/dist/adapters/node.mjs';
import { escapeHtml } from 'file:///Users/xiaoyou/Desktop/chronoframe/node_modules/.pnpm/@vue+shared@3.5.26/node_modules/@vue/shared/dist/shared.cjs.js';
import { migrate as migrate$2 } from 'file:///Users/xiaoyou/Desktop/chronoframe/node_modules/.pnpm/drizzle-orm@0.44.7_@cloudflare+workers-types@4.20251231.0_@opentelemetry+api@1.9.0_@typ_33833b556c54c3229140578f131c16f0/node_modules/drizzle-orm/better-sqlite3/migrator.js';
import { fileURLToPath } from 'node:url';
import defu, { defuFn, defu as defu$1, createDefu } from 'file:///Users/xiaoyou/Desktop/chronoframe/node_modules/.pnpm/defu@6.1.4/node_modules/defu/dist/defu.mjs';
import { html as html$1 } from 'file:///Users/xiaoyou/Desktop/chronoframe/node_modules/.pnpm/satori-html@0.3.2/node_modules/satori-html/dist/index.js';
import sizeOf from 'file:///Users/xiaoyou/Desktop/chronoframe/node_modules/.pnpm/image-size@2.0.2/node_modules/image-size/dist/index.mjs';
import consola, { createConsola, consola as consola$1 } from 'file:///Users/xiaoyou/Desktop/chronoframe/node_modules/.pnpm/consola@3.4.2/node_modules/consola/dist/index.mjs';
import { Launcher } from 'file:///Users/xiaoyou/Desktop/chronoframe/node_modules/.pnpm/chrome-launcher@1.2.1/node_modules/chrome-launcher/dist/index.js';
import playwrightCore from 'file:///Users/xiaoyou/Desktop/chronoframe/node_modules/.pnpm/playwright-core@1.57.0/node_modules/playwright-core/index.mjs';
import { toValue, isVNode, isRef } from 'file:///Users/xiaoyou/Desktop/chronoframe/node_modules/.pnpm/vue@3.5.26_typescript@5.9.3/node_modules/vue/index.mjs';
import z$1, { z } from 'file:///Users/xiaoyou/Desktop/chronoframe/node_modules/.pnpm/zod@4.2.1/node_modules/zod/index.js';
import { sql, and, eq, desc, asc, getTableColumns, isNotNull, inArray, or, gte } from 'file:///Users/xiaoyou/Desktop/chronoframe/node_modules/.pnpm/drizzle-orm@0.44.7_@cloudflare+workers-types@4.20251231.0_@opentelemetry+api@1.9.0_@typ_33833b556c54c3229140578f131c16f0/node_modules/drizzle-orm/index.js';
import { FetchError, createFetch, Headers as Headers$1 } from 'file:///Users/xiaoyou/Desktop/chronoframe/node_modules/.pnpm/ofetch@1.5.1/node_modules/ofetch/dist/node.mjs';
import { snakeCase, upperFirst } from 'file:///Users/xiaoyou/Desktop/chronoframe/node_modules/.pnpm/scule@1.3.0/node_modules/scule/dist/index.mjs';
import { getRandomValues } from 'file:///Users/xiaoyou/Desktop/chronoframe/node_modules/.pnpm/uncrypto@0.1.3/node_modules/uncrypto/dist/crypto.node.mjs';
import { defineI18nMiddleware, useTranslation } from 'file:///Users/xiaoyou/Desktop/chronoframe/node_modules/.pnpm/@intlify+h3@0.7.4/node_modules/@intlify/h3/dist/index.mjs';
import { readFile, mkdir, writeFile, unlink, mkdtemp, rm } from 'node:fs/promises';
import { exiftool } from 'file:///Users/xiaoyou/Desktop/chronoframe/node_modules/.pnpm/exiftool-vendored@30.5.0/node_modules/exiftool-vendored/dist/ExifTool.js';
import fs, { promises, readFileSync, createReadStream } from 'node:fs';
import * as si from 'file:///Users/xiaoyou/Desktop/chronoframe/node_modules/.pnpm/systeminformation@5.28.5/node_modules/systeminformation/lib/index.js';
import { Hash } from 'file:///Users/xiaoyou/Desktop/chronoframe/node_modules/.pnpm/@adonisjs+hash@9.1.1/node_modules/@adonisjs/hash/build/index.js';
import { Scrypt } from 'file:///Users/xiaoyou/Desktop/chronoframe/node_modules/.pnpm/@adonisjs+hash@9.1.1/node_modules/@adonisjs/hash/build/src/drivers/scrypt.js';
import sharp from 'file:///Users/xiaoyou/Desktop/chronoframe/node_modules/.pnpm/sharp@0.34.4/node_modules/sharp/lib/index.js';
import { createRenderer, getRequestDependencies, getPreloadLinks, getPrefetchLinks } from 'file:///Users/xiaoyou/Desktop/chronoframe/node_modules/.pnpm/vue-bundle-renderer@2.2.0/node_modules/vue-bundle-renderer/dist/runtime.mjs';
import destr, { destr as destr$1 } from 'file:///Users/xiaoyou/Desktop/chronoframe/node_modules/.pnpm/destr@2.0.5/node_modules/destr/dist/index.mjs';
import { parse, stringify, uneval } from 'file:///Users/xiaoyou/Desktop/chronoframe/node_modules/.pnpm/devalue@5.6.1/node_modules/devalue/index.js';
import { createHead as createHead$1, propsToString, renderSSRHead } from 'file:///Users/xiaoyou/Desktop/chronoframe/node_modules/.pnpm/unhead@2.1.1/node_modules/unhead/dist/server.mjs';
import { createStorage, prefixStorage, normalizeKey } from 'file:///Users/xiaoyou/Desktop/chronoframe/node_modules/.pnpm/unstorage@1.17.3_db0@0.3.4_better-sqlite3@12.5.0_drizzle-orm@0.44.7_@cloudflare+workers_249b788cdfd79360c828fdb59b11c5fa/node_modules/unstorage/dist/index.mjs';
import lruCacheDriver from 'file:///Users/xiaoyou/Desktop/chronoframe/node_modules/.pnpm/unstorage@1.17.3_db0@0.3.4_better-sqlite3@12.5.0_drizzle-orm@0.44.7_@cloudflare+workers_249b788cdfd79360c828fdb59b11c5fa/node_modules/unstorage/drivers/lru-cache.mjs';
import { createHooks } from 'file:///Users/xiaoyou/Desktop/chronoframe/node_modules/.pnpm/hookable@5.5.3/node_modules/hookable/dist/index.mjs';
import { fetchNodeRequestHandler, callNodeRequestHandler } from 'file:///Users/xiaoyou/Desktop/chronoframe/node_modules/.pnpm/node-mock-http@1.0.4/node_modules/node-mock-http/dist/index.mjs';
import unstorage_47drivers_47fs from 'file:///Users/xiaoyou/Desktop/chronoframe/node_modules/.pnpm/unstorage@1.17.3_db0@0.3.4_better-sqlite3@12.5.0_drizzle-orm@0.44.7_@cloudflare+workers_249b788cdfd79360c828fdb59b11c5fa/node_modules/unstorage/drivers/fs.mjs';
import { digest, hash as hash$1 } from 'file:///Users/xiaoyou/Desktop/chronoframe/node_modules/.pnpm/ohash@2.0.11/node_modules/ohash/dist/index.mjs';
import { klona } from 'file:///Users/xiaoyou/Desktop/chronoframe/node_modules/.pnpm/klona@2.0.6/node_modules/klona/dist/index.mjs';
import { getContext } from 'file:///Users/xiaoyou/Desktop/chronoframe/node_modules/.pnpm/unctx@2.5.0/node_modules/unctx/dist/index.mjs';
import { toRouteMatcher, createRouter } from 'file:///Users/xiaoyou/Desktop/chronoframe/node_modules/.pnpm/radix3@1.1.2/node_modules/radix3/dist/index.mjs';
import { ErrorParser } from 'file:///Users/xiaoyou/Desktop/chronoframe/node_modules/.pnpm/youch-core@0.3.3/node_modules/youch-core/build/index.js';
import { Youch } from 'file:///Users/xiaoyou/Desktop/chronoframe/node_modules/.pnpm/youch@4.1.0-beta.13/node_modules/youch/build/index.js';
import { SourceMapConsumer } from 'file:///Users/xiaoyou/Desktop/chronoframe/node_modules/.pnpm/source-map@0.7.6/node_modules/source-map/source-map.js';
import devalue from 'file:///Users/xiaoyou/Desktop/chronoframe/node_modules/.pnpm/@nuxt+devalue@2.0.2/node_modules/@nuxt/devalue/dist/devalue.mjs';
import { tryQueryLocale, tryCookieLocale, tryHeaderLocale } from 'file:///Users/xiaoyou/Desktop/chronoframe/node_modules/.pnpm/@intlify+utils@0.13.0/node_modules/@intlify/utils/dist/h3.mjs';
import { createPathIndexLanguageParser, parseAcceptLanguage } from 'file:///Users/xiaoyou/Desktop/chronoframe/node_modules/.pnpm/@intlify+utils@0.13.0/node_modules/@intlify/utils/dist/index.mjs';
import { parse as parse$1 } from 'file:///Users/xiaoyou/Desktop/chronoframe/node_modules/.pnpm/cookie-es@2.0.0/node_modules/cookie-es/dist/index.mjs';
import { createRouterMatcher } from 'file:///Users/xiaoyou/Desktop/chronoframe/node_modules/.pnpm/vue-router@4.6.4_vue@3.5.26_typescript@5.9.3_/node_modules/vue-router/vue-router.node.mjs';
import { AsyncLocalStorage } from 'node:async_hooks';
import { captureRawStackTrace, parseRawStackTrace } from 'file:///Users/xiaoyou/Desktop/chronoframe/node_modules/.pnpm/errx@0.1.0/node_modules/errx/dist/index.js';
import { drizzle } from 'file:///Users/xiaoyou/Desktop/chronoframe/node_modules/.pnpm/drizzle-orm@0.44.7_@cloudflare+workers-types@4.20251231.0_@opentelemetry+api@1.9.0_@typ_33833b556c54c3229140578f131c16f0/node_modules/drizzle-orm/better-sqlite3/index.js';
import Database from 'file:///Users/xiaoyou/Desktop/chronoframe/node_modules/.pnpm/better-sqlite3@12.5.0/node_modules/better-sqlite3/lib/index.js';
import { sqliteTable, integer, text, real, uniqueIndex } from 'file:///Users/xiaoyou/Desktop/chronoframe/node_modules/.pnpm/drizzle-orm@0.44.7_@cloudflare+workers-types@4.20251231.0_@opentelemetry+api@1.9.0_@typ_33833b556c54c3229140578f131c16f0/node_modules/drizzle-orm/sqlite-core/index.js';
import { PutObjectCommand, DeleteObjectCommand, GetObjectCommand, ListObjectsCommand, S3Client } from 'file:///Users/xiaoyou/Desktop/chronoframe/node_modules/.pnpm/@aws-sdk+client-s3@3.958.0/node_modules/@aws-sdk/client-s3/dist-cjs/index.js';
import { getSignedUrl } from 'file:///Users/xiaoyou/Desktop/chronoframe/node_modules/.pnpm/@aws-sdk+s3-request-presigner@3.958.0/node_modules/@aws-sdk/s3-request-presigner/dist-cjs/index.js';
import bmp from 'file:///Users/xiaoyou/Desktop/chronoframe/node_modules/.pnpm/@vingle+bmp-js@0.2.5/node_modules/@vingle/bmp-js/index.js';
import heicConvert from 'file:///Users/xiaoyou/Desktop/chronoframe/node_modules/.pnpm/heic-convert@2.1.0/node_modules/heic-convert/index.js';
import { rgbaToThumbHash } from 'file:///Users/xiaoyou/Desktop/chronoframe/node_modules/.pnpm/thumbhash@0.1.1/node_modules/thumbhash/thumbhash.js';
import { noop } from 'file:///Users/xiaoyou/Desktop/chronoframe/node_modules/.pnpm/es-toolkit@1.43.0/node_modules/es-toolkit/dist/index.mjs';
import { dirname as dirname$1, resolve as resolve$1, basename, isAbsolute } from 'file:///Users/xiaoyou/Desktop/chronoframe/node_modules/.pnpm/pathe@2.0.3/node_modules/pathe/dist/index.mjs';
import process$1 from 'node:process';
import { renderToString } from 'file:///Users/xiaoyou/Desktop/chronoframe/node_modules/.pnpm/vue@3.5.26_typescript@5.9.3/node_modules/vue/server-renderer/index.mjs';
import { walkResolver } from 'file:///Users/xiaoyou/Desktop/chronoframe/node_modules/.pnpm/unhead@2.1.1/node_modules/unhead/dist/utils.mjs';
import { getIcons } from 'file:///Users/xiaoyou/Desktop/chronoframe/node_modules/.pnpm/@iconify+utils@3.1.0/node_modules/@iconify/utils/lib/index.js';
import { collections } from 'file:///Users/xiaoyou/Desktop/chronoframe/.nuxt/nuxt-icon-server-bundle.mjs';
import { ipxFSStorage, ipxHttpStorage, createIPX, createIPXH3Handler } from 'file:///Users/xiaoyou/Desktop/chronoframe/node_modules/.pnpm/ipx@2.1.1_db0@0.3.4_better-sqlite3@12.5.0_drizzle-orm@0.44.7_@cloudflare+workers-types@_0a31be283312bb493ded801a86cbc10a/node_modules/ipx/dist/index.mjs';
import { createGenerator } from 'file:///Users/xiaoyou/Desktop/chronoframe/node_modules/.pnpm/@unocss+core@66.5.12/node_modules/@unocss/core/dist/index.mjs';
import presetWind from 'file:///Users/xiaoyou/Desktop/chronoframe/node_modules/.pnpm/@unocss+preset-wind3@66.5.12/node_modules/@unocss/preset-wind3/dist/index.mjs';
import { createUnhead } from 'file:///Users/xiaoyou/Desktop/chronoframe/node_modules/.pnpm/unhead@2.1.1/node_modules/unhead/dist/index.mjs';
import { Resvg } from 'file:///Users/xiaoyou/Desktop/chronoframe/node_modules/.pnpm/@resvg+resvg-js@2.6.2/node_modules/@resvg/resvg-js/index.js';
import _satori from 'file:///Users/xiaoyou/Desktop/chronoframe/node_modules/.pnpm/satori@0.15.2/node_modules/satori/dist/index.js';
...
const serverAssets = [{"baseName":"nuxt-og-image:fonts","dir":"/Users/xiaoyou/Desktop/chronoframe/.nuxt/cache/nuxt-og-image/_fonts"},{"baseName":"server","dir":"/Users/xiaoyou/Desktop/chronoframe/server/assets"}];
...
storage$1.mount('root', unstorage_47drivers_47fs({"driver":"fs","readOnly":true,"base":"/Users/xiaoyou/Desktop/chronoframe","watchOptions":{"ignored":[null]}}));
storage$1.mount('src', unstorage_47drivers_47fs({"driver":"fs","readOnly":true,"base":"/Users/xiaoyou/Desktop/chronoframe/server","watchOptions":{"ignored":[null]}}));
storage$1.mount('build', unstorage_47drivers_47fs({"driver":"fs","readOnly":false,"base":"/Users/xiaoyou/Desktop/chronoframe/.nuxt"}));
storage$1.mount('cache', unstorage_47drivers_47fs({"driver":"fs","readOnly":false,"base":"/Users/xiaoyou/Desktop/chronoframe/.nuxt/cache"}));
storage$1.mount('data', unstorage_47drivers_47fs({"driver":"fs","base":"/Users/xiaoyou/Desktop/chronoframe/.data/kv"}));
...
const _inlineRuntimeConfig = {
  ...
  "ipx": {
    ...
    "fs": {
      "dir": [
        "/Users/xiaoyou/Desktop/chronoframe/public"
      ]
    },
    "http": {
      "domains": []
...
const fetchMessages = async (locale) => await $fetch(`/_i18n/${"sq3P-Boj"}/${locale}/messages.json`, {
  headers
});
...
const rootDir = "/Users/xiaoyou/Desktop/chronoframe";
...
const _vZlK1PIKwcdzyojBIMv8y2zXrXKXxQwqKTaB7kynMCQ = (nitroApp) => {
...
_vZlK1PIKwcdzyojBIMv8y2zXrXKXxQwqKTaB7kynMCQ,
...
const getServerEntry = () => import('file:///Users/xiaoyou/Desktop/chronoframe/.nuxt//dist/server/server.mjs').then((r) => r.default || r);
const getClientManifest = () => import('file:///Users/xiaoyou/Desktop/chronoframe/.nuxt//dist/server/client.manifest.mjs').then((r) => r.default || r).then((r) => typeof r === "function" ? r() : r);
...
const _jlTyid = eventHandler(async (e) => {
  const siteConfig = getSiteConfig(e);
  const nitroOrigin = getNitroOrigin(e);
  const runtimeConfig = useRuntimeConfig(e);
...
const _Ei4Tra = _messagesHandler ;
...
const _lazy_MCNwR8 = () => Promise.resolve().then(function () { return index_delete$3; });
const _lazy_4odk7W = () => Promise.resolve().then(function () { return index_get$5; });
const _lazy_Cwd98U = () => Promise.resolve().then(function () { return index_put$3; });
const _lazy_l1KlT0 = () => Promise.resolve().then(function () { return _photoId__delete$1; });
const _lazy_w0aqUN = () => Promise.resolve().then(function () { return index_get$3; });
const _lazy_FnLBRk = () => Promise.resolve().then(function () { return index_post$3; });
const _lazy_YOLRyI = () => Promise.resolve().then(function () { return github_get$1; });
const _lazy_P_nUTM = () => Promise.resolve().then(function () { return login_post$1; });
const _lazy_ilzEFx = () => Promise.resolve().then(function () { return logout_get$1; });
const _lazy_Va30Uy = () => Promise.resolve().then(function () { return albums_get$1; });
const _lazy_A0njb3 = () => Promise.resolve().then(function () { return index_delete$1; });
const _lazy_xM65l2 = () => Promise.resolve().then(function () { return index_put$1; });
const _lazy_ywHfJK = () => Promise.resolve().then(function () { return livephoto_get$1; });
const _lazy_V_vPc5 = () => Promise.resolve().then(function () { return reactions$1; });
const _lazy_9KFqmj = () => Promise.resolve().then(function () { return checkDuplicate_post$1; });
const _lazy_M65H8i = () => Promise.resolve().then(function () { return reindex_post$1; });
const _lazy_cuZlHW = () => Promise.resolve().then(function () { return index_get$1; });
const _lazy_pR4Lc5 = () => Promise.resolve().then(function () { return index_post$1; });
const _lazy_l3BJy7 = () => Promise.resolve().then(function () { return manage_post$1; });
const _lazy_i3VUPC = () => Promise.resolve().then(function () { return reactions_get$1; });
const _lazy_y5_vCX = () => Promise.resolve().then(function () { return status_get$1; });
const _lazy_AFqgCC = () => Promise.resolve().then(function () { return upload_put$1; });
const _lazy_EoPusK = () => Promise.resolve().then(function () { return profile_get$1; });
const _lazy_os5S9h = () => Promise.resolve().then(function () { return addTask_post$1; });
const _lazy_K4vT6D = () => Promise.resolve().then(function () { return addTasks_post$1; });
const _lazy_2HpLIH = () => Promise.resolve().then(function () { return _taskId__get$1; });
const _lazy_M_0I31 = () => Promise.resolve().then(function () { return index$3; });
const _lazy_KyFLSR = () => Promise.resolve().then(function () { return clear_delete$1; });
const _lazy_A9WE4r = () => Promise.resolve().then(function () { return list_get$1; });
const _lazy_gzaaVo = () => Promise.resolve().then(function () { return retryBatch_post$1; });
const _lazy_dQbq39 = () => Promise.resolve().then(function () { return retry_post$1; });
const _lazy__Fz3ZP = () => Promise.resolve().then(function () { return logs$1; });
const _lazy_M_TxKR = () => Promise.resolve().then(function () { return _namespace__get$1; });
const _lazy_rOuytS = () => Promise.resolve().then(function () { return _key_$1; });
const _lazy_d4J6kY = () => Promise.resolve().then(function () { return all_get$1; });
const _lazy_Qp1uOf = () => Promise.resolve().then(function () { return batch_put$1; });
const _lazy_mg9ZYm = () => Promise.resolve().then(function () { return fields_get$1; });
const _lazy_ncweVx = () => Promise.resolve().then(function () { return schema_get$3; });
const _lazy_1w0gtQ = () => Promise.resolve().then(function () { return _id_$1; });
const _lazy_Hfs_ZN = () => Promise.resolve().then(function () { return index$1; });
const _lazy_UbsDcQ = () => Promise.resolve().then(function () { return stats_get$1; });
const _lazy_b9Pi7B = () => Promise.resolve().then(function () { return admin_post$1; });
const _lazy_FL59rL = () => Promise.resolve().then(function () { return complete_post$1; });
const _lazy_96S18o = () => Promise.resolve().then(function () { return map_post$1; });
const _lazy_TzTvDF = () => Promise.resolve().then(function () { return schema_get$1; });
const _lazy_rcaYZd = () => Promise.resolve().then(function () { return site_post$1; });
const _lazy_WG7jqv = () => Promise.resolve().then(function () { return storage_post$1; });
const _lazy_jR6jm6 = () => Promise.resolve().then(function () { return submit_post$1; });
const _lazy_eU1JrH = () => Promise.resolve().then(function () { return ____key__get$1; });
const _lazy_TgVvLW = () => Promise.resolve().then(function () { return ____path_$1; });
const _lazy_MxAL9C = () => Promise.resolve().then(function () { return ____thumbnailUrl__get$1; });
const _lazy_9td0xI = () => Promise.resolve().then(function () { return renderer$1; });
const _lazy_mL1US7 = () => Promise.resolve().then(function () { return font$1; });
const _lazy_b3vBja = () => Promise.resolve().then(function () { return debug_json$1; });
const _lazy_QCmKEV = () => Promise.resolve().then(function () { return image$1; });
...
const handlers = [
  ...
  { route: '/__site-config__/debug.json', handler: _jlTyid, lazy: false, middleware: false, method: undefined },
  { route: '/__og-image__/debug.json', handler: _lazy_b3vBja, lazy: true, middleware: false, method: undefined },
  ...
  { route: '/_fonts/**', handler: _lazy_9td0xI, lazy: true, middleware: false, method: undefined },
