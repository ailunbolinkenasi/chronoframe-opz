import { q as useI18n, u as useHead, D as useToast, aL as useFetch, B as _sfc_main$1, aM as setInterval, am as _sfc_main$5, _ as _export_sfc } from "../server.mjs";
import { _ as _sfc_main$2, a as _sfc_main$7 } from "./DashboardNavbar-DXyxgaXz.js";
...
import { _ as _sfc_main$4 } from "./Table-Cek17xfi.js";
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(ssrRenderComponent(_component_UDashboardPanel, _attrs, {
        ...
        body: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<div class="flex flex-col gap-6" data-v-e7a86c9e${_scopeId}><div class="grid grid-cols-2 lg:grid-cols-4 gap-4" data-v-e7a86c9e${_scopeId}>`);
            ...
            _push2(ssrRenderComponent(_component_UCard, null, {
              header: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`<div class="flex items-center justify-between pb-2" data-v-e7a86c9e${_scopeId2}><h2 class="text-lg font-semibold" data-v-e7a86c9e${_scopeId2}>队列任务列表</h2><div class="flex items-center gap-2" data-v-e7a86c9e${_scopeId2}>`);
              ...
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`<div class="space-y-4" data-v-e7a86c9e${_scopeId2}>`);
                  _push3(ssrRenderComponent(_component_UTable, {
                    ...
                    "attempts-cell": withCtx(({ row }, _push4, _parent4, _scopeId3) => {
                      if (_push4) {
                        _push4(`<span class="text-sm" data-v-e7a86c9e${_scopeId3}>${ssrInterpolate(row.original.attempts)}/${ssrInterpolate(row.original.maxAttempts)}</span>`);
                      } else {
                        return [
                    ...
                    "statusStage-cell": withCtx(({ row }, _push4, _parent4, _scopeId3) => {
                      if (_push4) {
                        if (row.original.statusStage) {
                          _push4(`<span class="text-xs text-gray-500" data-v-e7a86c9e${_scopeId3}>${ssrInterpolate(unref($t)(`dashboard.queue.stages.${row.original.statusStage}`))}</span>`);
                        } else {
                          _push4(`<span class="text-xs text-gray-400" data-v-e7a86c9e${_scopeId3}>-</span>`);
                        }
                      } else {
                        return [
                    ...
                    "createdAt-cell": withCtx(({ row }, _push4, _parent4, _scopeId3) => {
                      if (_push4) {
                        _push4(`<span class="text-sm" data-v-e7a86c9e${_scopeId3}>${ssrInterpolate(_ctx.$dayjs(row.original.createdAt).format("MM-DD HH:mm:ss"))}</span>`);
                      } else {
                        return [
                    ...
                    "actions-cell": withCtx(({ row }, _push4, _parent4, _scopeId3) => {
                      if (_push4) {
                        _push4(`<div class="flex items-center gap-1" data-v-e7a86c9e${_scopeId3}>`);
                    ...
                    expanded: withCtx(({ row }, _push4, _parent4, _scopeId3) => {
                      if (_push4) {
                        _push4(`<div class="px-2" data-v-e7a86c9e${_scopeId3}><div class="space-y-3" data-v-e7a86c9e${_scopeId3}><div class="flex gap-4" data-v-e7a86c9e${_scopeId3}><div data-v-e7a86c9e${_scopeId3}><p class="text-xs text-neutral-500" data-v-e7a86c9e${_scopeId3}>PhotoId</p><p class="text-sm capitalize" data-v-e7a86c9e${_scopeId3}>${ssrInterpolate(row.original.payload.photoId || "-")}</p></div><div data-v-e7a86c9e${_scopeId3}><p class="text-xs text-neutral-500" data-v-e7a86c9e${_scopeId3}>${ssrInterpolate(unref($t)("dashboard.queue.table.id"))}</p><p class="font-mono text-sm" data-v-e7a86c9e${_scopeId3}>${ssrInterpolate(row.original.id)}</p></div><div data-v-e7a86c9e${_scopeId3}><p class="text-xs text-neutral-500" data-v-e7a86c9e${_scopeId3}>${ssrInterpolate(unref($t)("dashboard.queue.table.type"))}</p><p class="text-sm capitalize" data-v-e7a86c9e${_scopeId3}>${ssrInterpolate(row.original.payload.type)}</p></div></div>`);
                        if (row.original.status === "failed" && row.original.errorMessage) {
                          _push4(`<div class="mt-3" data-v-e7a86c9e${_scopeId3}><p class="text-xs text-neutral-500 mb-1" data-v-e7a86c9e${_scopeId3}>${ssrInterpolate(unref($t)("dashboard.queue.table.errorMessage"))}</p><div class="p-3 bg-red-50 dark:bg-red-950/20 rounded border border-red-100 dark:border-red-900/30" data-v-e7a86c9e${_scopeId3}><p class="text-sm text-red-700 dark:text-red-300 wrap-break-word font-mono" data-v-e7a86c9e${_scopeId3}>${ssrInterpolate(row.original.errorMessage)}</p></div></div>`);
                        } else {
                          _push4(`<!---->`);
                        }
                        if (row.original.payload) {
                          _push4(`<div class="mt-3" data-v-e7a86c9e${_scopeId3}><p class="text-xs text-gray-500 mb-1" data-v-e7a86c9e${_scopeId3}>Payload</p><pre class="text-xs bg-neutral-100/50 dark:bg-neutral-800/50 p-2 rounded overflow-x-auto text-neutral-700 dark:text-neutral-300" data-v-e7a86c9e${_scopeId3}>${ssrInterpolate(JSON.stringify(row.original.payload, null, 2))}</pre></div>`);
                        } else {
                          _push4(`<!---->`);
                        }
                        _push4(`</div></div>`);
...
const queue = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-e7a86c9e"]]);
export {
  queue as default
};
