...
import { _ as _sfc_main$5 } from './Textarea-BK55nnMy.mjs';
import { a as _sfc_main$4 } from './SelectMenu-B-dQe02o.mjs';
import { ref, reactive, readonly, defineComponent, resolveComponent, computed, createVNode, resolveDynamicComponent, unref, mergeProps, withCtx, createBlock, openBlock, useSlots, useId, renderSlot, createTextVNode, toDisplayString, createCommentVNode, Fragment, renderList, toRefs, withKeys, withModifiers, useSSRContext } from 'vue';
import { ssrRenderVNode, ssrRenderComponent, ssrRenderAttrs, ssrRenderClass, ssrRenderSlot, ssrInterpolate, ssrRenderList } from 'vue/server-renderer';
import { D as useToast, q as useI18n, T as useAppConfig, ag as useForwardPropsEmits, V as reactivePick, a8 as useFormField, W as tv, as as get, Y as useForwardExpose, h as useVModel$1, ae as createContext$1, S as Primitive, b2 as useEventListener$1, ah as Presence_default } from './server.mjs';
import { a as _sfc_main$6, L as Label_default } from './FormField-DW0IB9L7.mjs';
...
import { _ as _sfc_main$3 } from './Tabs-BgfmQzYA.mjs';
...
var Radio_vue_vue_type_script_setup_true_lang_default = /* @__PURE__ */ defineComponent({
  ...
  setup(__props, { emit: __emit }) {
    const props = __props;
    const emits = __emit;
    const checked = useVModel$1(props, "checked", emits, { passive: props.checked === void 0 });
...
const [injectRadioGroupRootContext, provideRadioGroupRootContext] = createContext$1("RadioGroupRoot");
...
const [injectRadioGroupItemContext, provideRadiogroupItemContext] = createContext$1("RadioGroupItem");
...
export { __nuxt_component_4 as _, useSettingsForm as u };
//# sourceMappingURL=useSettingsForm-CGAlNuJo.mjs.map
