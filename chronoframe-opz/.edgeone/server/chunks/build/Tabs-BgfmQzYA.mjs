import { useSlots, computed, ref, unref, defineComponent, mergeProps, withCtx, renderSlot, createBlock, createCommentVNode, openBlock, createTextVNode, toDisplayString, createVNode, Fragment, renderList, toRefs, watch, nextTick, withKeys, withModifiers, normalizeStyle, useSSRContext } from 'vue';
import { ssrRenderComponent, ssrRenderSlot, ssrRenderList, ssrRenderClass, ssrInterpolate } from 'vue/server-renderer';
import { T as useAppConfig, ag as useForwardPropsEmits, V as reactivePick, W as tv, Q as _sfc_main$B, X as _sfc_main$y, as as get, R as _sfc_main$8, Y as useForwardExpose, h as useVModel$1, ae as createContext$1, S as Primitive, ap as useResizeObserver, ah as Presence_default } from './server.mjs';
...
const [injectTabsRootContext, provideTabsRootContext] = createContext$1("TabsRoot");
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("../node_modules/.pnpm/@nuxt+ui@4.3.0_ce70e36b2b2e96ffad445540e21eec42/node_modules/@nuxt/ui/dist/runtime/components/Tabs.vue");
  return _sfc_setup ? _sfc_setup(props, ctx) : void 0;
};

export { _sfc_main as _ };
//# sourceMappingURL=Tabs-BgfmQzYA.mjs.map
