import { q as useI18n, v as useRoute, w as useRouter, C as useUserSession, u as useHead, N as getSetting, l as __nuxt_component_0$4, B as _sfc_main$v, a as __nuxt_component_0$5, b6 as __nuxt_component_7, F as useNuxtApp, T as useAppConfig, W as tv, S as Primitive, aF as useLocale, am as createReusableTemplate, ag as useForwardPropsEmits, V as reactivePick, ar as isArrayOfArray, X as _sfc_main$y, Q as _sfc_main$B, as as get, R as _sfc_main$8, a_ as _sfc_main$w, a$ as pickLinkProps, b0 as _sfc_main$x, ak as usePortal, af as VisuallyHidden_default, ae as createContext$1, Y as useForwardExpose, ao as useCollection, r as refAutoReset, b1 as reactiveOmit$1, b5 as isClient, ah as Presence_default, h as useVModel$1, b4 as useDebounceFn$1, ap as useResizeObserver, aq as getActiveElement, b as unrefElement$1, b2 as useEventListener$1 } from './server.mjs';
import { defineComponent, computed, unref, mergeProps, withCtx, createTextVNode, createVNode, toDisplayString, createBlock, openBlock, ref, renderSlot, mergeModels, useSlots, useModel, useId, toRef, watch, createCommentVNode, resolveDynamicComponent, withModifiers, Fragment, renderList, onScopeDispose, toHandlers, withKeys, createElementBlock, Teleport, toRefs, watchEffect, nextTick, normalizeStyle, createElementVNode, getCurrentInstance, useSSRContext } from 'vue';
import { ssrRenderAttrs, ssrRenderComponent, ssrInterpolate, ssrRenderAttr, ssrRenderSlot, ssrRenderClass, ssrRenderVNode, ssrRenderList } from 'vue/server-renderer';
import { b as _sfc_main$5, p as provideDashboardContext, u as useDashboard, a as useResizable, _ as _sfc_main$1$2 } from './DashboardSidebarToggle-CGdUeE5a.mjs';
import { Z as publicAssetsURL, ar as defu, az as isEqual } from '../nitro/nitro.mjs';
import { a as _sfc_main$6, _ as _sfc_main$1$1, D as DialogTrigger_default, b as DialogPortal_default, c as DialogTitle_default, d as DialogDescription_default, e as DialogRoot_default, f as DialogOverlay_default, g as DialogContent_default } from './Modal-BpC2u0WJ.mjs';
...
import { _ as _sfc_main$7, u as useArrowNavigation } from './Popover-CExH6mye.mjs';
import { u as useId$1 } from './useId-CmnGJZbL.mjs';
import { D as DismissableLayer_default } from './DismissableLayer-nRn6FzYo.mjs';
import { _ as _sfc_main$9 } from './Tooltip-DdVqfxhL.mjs';
import 'pinia';
import 'vue-router';
import 'devalue';
import 'dayjs';
...
const [injectCollapsibleRootContext, provideCollapsibleRootContext] = createContext$1("CollapsibleRoot");
...
const [injectAccordionRootContext, provideAccordionRootContext] = createContext$1("AccordionRoot");
...
const [injectAccordionItemContext, provideAccordionItemContext] = createContext$1("AccordionItem");
...
const [injectNavigationMenuContext, provideNavigationMenuContext] = createContext$1(["NavigationMenuRoot", "NavigationMenuSub"], "NavigationMenuContext");
var NavigationMenuRoot_vue_vue_type_script_setup_true_lang_default = /* @__PURE__ */ defineComponent({
  ...
  setup(__props, { emit: __emit }) {
    ...
    const debouncedFn = useDebounceFn$1((val) => {
...
const [injectNavigationMenuItemContext, provideNavigationMenuItemContext] = createContext$1("NavigationMenuItem");
...
const [ee, ct] = createContext$1("DrawerRoot"), Ee = /* @__PURE__ */ new WeakMap();
          ...
          if (_push2) {
            ...
            return [
              renderSlot(_ctx.$slots, "resize-handle", {
                ...
                __props.resizable ? (openBlock(), createBlock(_sfc_main$1$2, {
                  key: 0,
                  "aria-controls": id,
                  "data-slot": "handle",
                  class: ui.value.handle({ class: props.ui?.handle }),
                    ...
                    if (_push3) {
                      ...
                      return [
                        renderSlot(_ctx.$slots, item.slot ? `${item.slot}-trailing` : "item-trailing", {
                          ...
                          __props.orientation === "horizontal" && (item.children?.length || !!slots[item.slot ? `${item.slot}-content` : "item-content"]) || __props.orientation === "vertical" && item.children?.length ? (openBlock(), createBlock(_sfc_main$B, {
                            key: 1,
                            name: item.trailingIcon || __props.trailingIcon || unref(appConfig).ui.icons.chevronDown,
                            "data-slot": "linkTrailingIcon",
                            class: ui.value.linkTrailingIcon({ class: [props.ui?.linkTrailingIcon, item.ui?.linkTrailingIcon], active })
                          }, null, 8, ["name", "class"])) : item.trailingIcon ? (openBlock(), createBlock(_sfc_main$B, {
                            key: 2,
                            name: item.trailingIcon,
                            "data-slot": "linkTrailingIcon",
                            class: ui.value.linkTrailingIcon({ class: [props.ui?.linkTrailingIcon, item.ui?.linkTrailingIcon], active })
            ...
            return [
              renderSlot(_ctx.$slots, item.slot || "item", {
                ...
                renderSlot(_ctx.$slots, item.slot ? `${item.slot}-leading` : "item-leading", {
                  ...
                  item.avatar ? (openBlock(), createBlock(_sfc_main$y, mergeProps({
                    key: 0,
                    size: item.ui?.linkLeadingAvatarSize || props.ui?.linkLeadingAvatarSize || ui.value.linkLeadingAvatarSize()
                  }, item.avatar, {
                    "data-slot": "linkLeadingAvatar",
                    class: ui.value.linkLeadingAvatar({ class: [props.ui?.linkLeadingAvatar, item.ui?.linkLeadingAvatar], active, disabled: !!item.disabled })
                  }), null, 16, ["size", "class"])) : item.icon ? (openBlock(), createBlock(_sfc_main$B, {
                    key: 1,
                    name: item.icon,
                    "data-slot": "linkLeadingIcon",
                    class: ui.value.linkLeadingIcon({ class: [props.ui?.linkLeadingIcon, item.ui?.linkLeadingIcon], active, disabled: !!item.disabled })
              ...
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  if (__props.orientation === "vertical" && item.type === "label" && !__props.collapsed) {
                    ...
                    _push3(ssrRenderComponent(_sfc_main$w, mergeProps(__props.orientation === "vertical" && item.children?.length && !__props.collapsed && item.type === "trigger" ? {} : unref(pickLinkProps)(item), { custom: "" }), {
                              ...
                              if (_push5) {
                                if (__props.orientation === "vertical" && __props.collapsed && item.children?.length && (!!props.popover || !!item.popover)) {
                                  _push5(ssrRenderComponent(_sfc_main$7, mergeProps({ ...popoverProps.value, ...typeof item.popover === "boolean" ? {} : item.popover || {} }, {
                                      ...
                                      if (_push6) {
                                        ssrRenderSlot(_ctx.$slots, item.slot ? `${item.slot}-content` : "item-content", {
                                          ...
                                          ssrRenderList(item.children, (childItem, childIndex) => {
                                            ...
                                            _push6(ssrRenderComponent(_sfc_main$w, mergeProps({ ref_for: true }, unref(pickLinkProps)(childItem), { custom: "" }), {
                                                ...
                                                if (_push7) {
                                                  _push7(ssrRenderComponent(unref(NavigationMenuLink_default), {
                                                    ...
                                                    default: withCtx((_4, _push8, _parent8, _scopeId7) => {
                                                      if (_push8) {
                                                        _push8(ssrRenderComponent(_sfc_main$x, mergeProps({ ref_for: true }, childSlotProps, {
                                                          "data-slot": "childLink",
                                                          ...
                                                          default: withCtx((_5, _push9, _parent9, _scopeId8) => {
                                                            if (_push9) {
                                                              ...
                                                              return [
                                                                childItem.icon ? (openBlock(), createBlock(_sfc_main$B, {
                                                                  key: 0,
                                                                  name: childItem.icon,
                                                                  "data-slot": "childLinkIcon",
                                                                  class: ui.value.childLinkIcon({ class: [props.ui?.childLinkIcon, item.ui?.childLinkIcon], active: childActive })
                                                                ...
                                                                createVNode("span", {
                                                                  ...
                                                                  childItem.target === "_blank" && __props.externalIcon !== false ? (openBlock(), createBlock(_sfc_main$B, {
                                                                    key: 0,
                                                                    name: typeof __props.externalIcon === "string" ? __props.externalIcon : unref(appConfig).ui.icons.external,
                                                                    "data-slot": "childLinkLabelExternalIcon",
                                                                    class: ui.value.childLinkLabelExternalIcon({ class: [props.ui?.childLinkLabelExternalIcon, item.ui?.childLinkLabelExternalIcon], active: childActive })
                                                        ...
                                                        return [
                                                          createVNode(_sfc_main$x, mergeProps({ ref_for: true }, childSlotProps, {
                                                            "data-slot": "childLink",
                                                            class: ui.value.childLink({ class: [props.ui?.childLink, item.ui?.childLink, childItem.class], active: childActive })
                                                          }), {
                                                            default: withCtx(() => [
                                            ...
                                            createVNode("ul", {
                                              ...
                                              (openBlock(true), createBlock(Fragment, null, renderList(item.children, (childItem, childIndex) => {
                                                return openBlock(), createBlock("li", {
                                                  ...
                                                  createVNode(_sfc_main$w, mergeProps({ ref_for: true }, unref(pickLinkProps)(childItem), { custom: "" }), {
                                    ...
                                    default: withCtx((_4, _push6, _parent6, _scopeId5) => {
                                      if (_push6) {
                                        _push6(ssrRenderComponent(_sfc_main$x, mergeProps(slotProps, {
                                          "data-slot": "link",
                                  ...
                                  _push5(ssrRenderComponent(_sfc_main$x, mergeProps(slotProps, {
                                    "data-slot": "link",
                                ...
                                return [
                                  __props.orientation === "vertical" && __props.collapsed && item.children?.length && (!!props.popover || !!item.popover) ? (openBlock(), createBlock(_sfc_main$7, mergeProps({ key: 0 }, { ...popoverProps.value, ...typeof item.popover === "boolean" ? {} : item.popover || {} }, {
                                    ...
                                    _: 2
                                  }, 1040, ["text"])) : (openBlock(), createBlock(_sfc_main$x, mergeProps({ key: 2 }, slotProps, {
                                    "data-slot": "link",
                                    class: ui.value.link({ class: [props.ui?.link, item.ui?.link, item.class], active: active || item.active, disabled: !!item.disabled, level: __props.orientation === "horizontal" || level > 0 })
                                  }), {
                                    default: withCtx(() => [
                                ...
                                if (_push5) {
                                  ssrRenderSlot(_ctx.$slots, item.slot ? `${item.slot}-content` : "item-content", {
                                    ...
                                    ssrRenderList(item.children, (childItem, childIndex) => {
                                      ...
                                      _push5(ssrRenderComponent(_sfc_main$w, mergeProps({ ref_for: true }, unref(pickLinkProps)(childItem), { custom: "" }), {
                                          ...
                                          if (_push6) {
                                            _push6(ssrRenderComponent(unref(NavigationMenuLink_default), {
                                              ...
                                              default: withCtx((_4, _push7, _parent7, _scopeId6) => {
                                                if (_push7) {
                                                  _push7(ssrRenderComponent(_sfc_main$x, mergeProps({ ref_for: true }, childSlotProps, {
                                                    "data-slot": "childLink",
                                                    class: ui.value.childLink({ class: [props.ui?.childLink, item.ui?.childLink, childItem.class], active: childActive })
                                                  }), {
                  ...
                  return [
                    ...
                    ], 2)) : item.type !== "label" ? (openBlock(), createBlock(_sfc_main$w, mergeProps({ key: 1 }, __props.orientation === "vertical" && item.children?.length && !__props.collapsed && item.type === "trigger" ? {} : unref(pickLinkProps)(item), { custom: "" }), {
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      const _component_UDashboardSidebarToggle = _sfc_main$5;
...
//# sourceMappingURL=dashboard-Bbh7JJ8e.mjs.map
