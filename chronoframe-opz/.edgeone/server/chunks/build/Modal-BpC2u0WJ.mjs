import { defineComponent, useSlots, toRef, computed, unref, mergeProps, withCtx, toHandlers, renderSlot, createTextVNode, toDisplayString, createBlock, createCommentVNode, openBlock, createVNode, Fragment, normalizeProps, guardReactiveProps, ref, toRefs, useSSRContext } from 'vue';
import { ssrRenderComponent, ssrRenderSlot, ssrInterpolate, ssrRenderClass } from 'vue/server-renderer';
import { aF as useLocale, T as useAppConfig, ag as useForwardPropsEmits, V as reactivePick, ak as usePortal, am as createReusableTemplate, W as tv, af as VisuallyHidden_default, B as _sfc_main$v, ae as createContext$1, Y as useForwardExpose, S as Primitive, ai as Teleport_default, h as useVModel$1, aW as useEmitAsProps, ah as Presence_default } from './server.mjs';
import { d as useHideOthers, c as useBodyScrollLock, F as FocusScope_default } from './DashboardSidebarToggle-CGdUeE5a.mjs';
import { u as useId } from './useId-CmnGJZbL.mjs';
import { D as DismissableLayer_default } from './DismissableLayer-nRn6FzYo.mjs';
import { g as getOpenState } from './utils-Cesy8nNq.mjs';
                                  ...
                                  default: withCtx((_3, _push5, _parent5, _scopeId4) => {
                                    if (_push5) {
                                      ssrRenderSlot(_ctx.$slots, "close", { ui: ui.value }, () => {
                                        if (props.close) {
                                          _push5(ssrRenderComponent(_sfc_main$v, mergeProps({
                                      ...
                                      return [
                                        renderSlot(_ctx.$slots, "close", { ui: ui.value }, () => [
                                          props.close ? (openBlock(), createBlock(_sfc_main$v, mergeProps({
                                            key: 0,
                                            icon: __props.closeIcon || unref(appConfig).ui.icons.close,
                                            color: "neutral",
                                            variant: "ghost",
...
export { DialogTrigger_default as D, _sfc_main$1 as _, _sfc_main as a, DialogPortal_default as b, DialogTitle_default as c, DialogDescription_default as d, DialogRoot_default as e, DialogOverlay_default as f, DialogContent_default as g };
//# sourceMappingURL=Modal-BpC2u0WJ.mjs.map
